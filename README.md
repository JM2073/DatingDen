...
There is also a new .NET MAUI mobile project in `RelationshipPlanner.Mobile/`, ready for Android emulator testing.
...
- Open `RelationshipPlanner.slnx` in Visual Studio to work with both apps together.
